...
},
{
  ...
  "number": "1.2.3.1",
  "title": "",
  "body": "Which payoff does a player prefer: or ?   Correct. is the largest payoff.   is not the largest payoff.   is not the largest payoff.   3 "
},
{
  ...
  "number": "1.2.3.2",
  "title": "",
  "body": "Which payoff does a player prefer: or ?   Correct. is the largest payoff.   is not the largest payoff.   is not the largest payoff.   -1 "
},
{
  ...
  "number": "1.2.3.3",
  "title": "",
  "body": "Which payoff does a player prefer: or ?   Correct. is the largest payoff.   is not the largest payoff.   is not the largest payoff.   5\/6 "
},
{
...
},
{
  ...
  "body": " Zero-sum in Cake Division   Consider the cake division game. We want to find the payoff matrix for this game. It is important to determine what each player's options are first. How can the cutter cut the cake? How can the chooser pick her piece? The payoff matrix is given in .   Payoff matrix for Cake Cutting game. Cake Cutting game game Cake Cutting      Chooser      Larger Piece  Smaller Piece    Cutter  Cut Evenly  (half, half)  (half, half)     Cut Unvenly  (small piece, large piece)  (large piece, small piece)     In order to better see that this game is zero-sum (or constant-sum), we could give values for the amount of cake each player gets. For example, half the cake would be 50%, a small piece might be 40%. Then we can rewrite the matrix with the percentage values in    Payoff matrix, in percent of cake, for the Cake Cutting game.      Chooser      Larger Piece  Smaller Piece    Cutter  Cut Evenly       Cut Unvenly       In each outcome, the payoffs to each player add up to 100 (or 100%). In more mathematical terms, the coordinates of each payoff vector add up to 100. Thus the sum is the same, or constant, for each outcome.   "
},
{
...
},
{
  ...
  "number": "2.2.9",
  "title": "",
  "body": "dominates dominated by dominated strategy strategy dominated   A strategy  dominates a strategy if every entry for is greater than or equal to the corresponding entry for . In this case, we say is dominated by  .  If strategy dominates stratgy , we can write .   "
},
{
  "id": "F_strikerow2Ex2",
  "level": "2",
...
},
{
  ...
  "body": "Experimenting with different values  Let's see if we can create a matrix for a zero-sum game that has two equilibrium points with different values. Let's assume the two equilbria are and .  Create a matrix with and in the same row. Can they both be equilibria, or does one player want to switch?  Create a matrix with and in the same column. Can they both be equilibria, or does one player want to switch?  Now place and diagonally in the matrix (different rows and columns). Try to fill in values for the other two places in the matrix so that is an equilibrium. Is an equilibrium in any of your examples? Remember, if is an equilibrium, then must be the biggest value for Player 1 in the column and is the smallest in the row, so that is the biggest for Player 2 in the row.  Do you think it is possible to have both and be equilibrium points in a matrix? Explain your answer based on your examples.  "
},
{
  "id": "T_STfZSG",
  "level": "2",
...
},
{
  ...
  "number": "2.7.9",
  "title": "",
  "body": "Find a news article that describes a political or economic situation a being a zero-sum game. Do you agree that the situation is a zero-sum game? Discuss how viewing the situation as a zero-sum game affects the behavior of the players. "
},
{
  "id": "S_IntroRepeated",
  "level": "1",
