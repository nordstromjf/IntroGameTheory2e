...
},
{
  ...
  "number": "1.1.3.1",
  "title": "",
  "body": "True or False: If a player has perfect information, then they know exactly how their opponent will play the game. The player knows their opponent's choices and the outcomes of those choices, but does not necessarily know which choice their opponent will actually make. False. "
},
{
...
},
{
  "id": "D_payoff",
  "level": "2",
  "url": "S_IntroMatrices.html#D_payoff",
  "type": "Definition",
  "number": "1.2.2",
  "title": "",
  "body": "payoff   A payoff is the amount a player receives for a given outcome of the game.   "
},
{
...
},
{
  ...
  "body": " Preferred payoffs  Determine best payoff in each of the following.  Which payoff does a player prefer: or ?  Which payoff does a player prefer: or ?  Which payoff does a player prefer: or ?  "
},
{
  ...
  "type": "Activity",
  "number": "1.2.2",
  "title": "Finding strategies for a <span class=\"process-math\">\\(2 \\times 2\\)<\/span> game.",
  "body": " Finding strategies for a game  Suppose two players are playing a game in which they can choose A or B with the payoffs given in the game matrix in .   Payoff matrix for      Player 2      A  B    Player 1  A       B       Just by quickly looking at the matrix, which player appears to be able to win more than the other player? Does one player seem to have an advantage? Explain.  Determine what each player should do. Explain your answer.  Compare your answer in (b) to your answer in (a). Did the player you suggested in (a) actually win more than the other player?  According to your answer in (b), does Player 1 end up with the largest possible payoff (for Player 1) in the matrix?  According to your answer in (b), does Player 2 end up with the largest possible payoff (for Player 2) in the matrix?  Do you still think a player has an advantage in this game? Is it the same answer as in (a)?  "
},
{
  ...
  "type": "Activity",
  "number": "1.2.3",
  "title": "Finding strategies for a <span class=\"process-math\">\\(3 \\times 3\\)<\/span> game.",
  "body": " Finding strategies for a game  Suppose there are two players with the game matrix given in .   Payoff matrix for      Player 2      X  Y  Z     A       Player 1  B        C        Just by quickly looking at the matrix, which player appears to be able to win more than the other player? Does one player seem to have an advantage? Explain.  Determine what each player should do. Explain your answer.  Compare your answer in (b) to your answer in (a). Did the player you suggested in (a) actually win more than the other player?  According to your answer in (b), does Player 1 end up with the largest possible payoff (for Player 1) in the matrix?  According to your answer in (b), does Player 2 end up with the largest possible payoff (for Player 2) in the matrix?  Do you still think a player has an advantage in this game? Is it the same answer as in (a)?  "
},
{
  ...
  "number": "1.2.3.1",
  "title": "",
  "body": "Which payoff does a player prefer: or ?   Correct. is the largest payoff.   is not the largest payoff.   is not the largest payoff.   "
},
{
  ...
  "number": "1.2.3.2",
  "title": "",
  "body": "Which payoff does a player prefer: or ?   is not the largest payoff.   Correct. is the largest payoff.   is not the largest payoff.   "
},
{
  ...
  "number": "1.2.3.3",
  "title": "",
  "body": "Which payoff does a player prefer: or ?   is not the largest payoff.   is not the largest payoff.   Correct. is the largest payoff.   "
},
{
...
},
{
  ...
  "number": "1.2.3.7",
  "title": "",
  "body": " Using the game matrix in .  What row should Player 1 choose?  A Correct. Player 1 always does better by choosing A, no matter what Player 2 does.   B Incorrect.    A, Player 1 always does better by choosing A, no matter what Player 2 does. "
},
{
  ...
  "number": "1.2.3.8",
  "title": "",
  "body": " Using the game matrix in .  Which player has the advantage in this game?  Player 1 Can Player 1 prevent a negative payoff if Player 2 chooses D?   Player 2 If Player 2 chooses D, then Player 2 always has a positive payoff, while Player 1 always has a negative payoff.    Player 2. If Player 2 chooses D, then Player 2 always has a positive payoff, while Player 1 always has a negative payoff. "
},
{
  "id": "S_IntroZeroSum",
  "level": "1",
...
},
{
  ...
  "number": "2.1.1",
  "title": "",
  "body": "zero-sum game constant-sum game constant-sum game zero-sum game   A two player game is called a zero-sum game if the sum of the payoffs to each player is constant for all possible outcomes of the game. More specifically, the coordinates in each payoff vector must add up to the same value for each payoff vector. Such games are sometimes called constant-sum games instead.   "
},
{
  "id": "E_poker",
  "level": "2",
  "url": "S_IntroZeroSum.html#E_poker",
  "type": "Example",
  "number": "2.1.2",
...
},
{
  ...
  "body": " Zero-sum in Cake Division   Consider the cake division game. We want to find the payoff matrix for this game. It is important to determine what each player's options are first. How can the cutter cut the cake? How can the chooser pick her piece? The payoff matrix is given in .   Payoff matrix for Cake Cutting game. Cake Cutting game game Cake Cutting      Chooser      Larger Piece  Smaller Piece    Cutter  Cut Evenly  (half, half)  (half, half)     Cut Unevenly  (small piece, large piece)  (large piece, small piece)     In order to better see that this game is zero-sum (or constant-sum), we could give values for the amount of cake each player gets. For example, half the cake would be 50%, a small piece might be 40%. Then we can rewrite the matrix with the percentage values in    Payoff matrix, in percent of cake, for the Cake Cutting game.      Chooser      Larger Piece  Smaller Piece    Cutter  Cut Evenly       Cut Unevenly       In each outcome, the payoffs to each player add up to 100 (or 100%). In more mathematical terms, the coordinates of each payoff vector add up to 100. Thus the sum is the same, or constant, for each outcome.   "
},
{
...
},
{
  ...
  "body": " Poker Payoffs Revisited   Consider the poker game from where each player begins the game with $100. Suppose at some point in the game the five players have the following amounts of money: $50, $200, $140, $100, $10. Then we could think of their gain as -$50, $100, $40, $0, -$90. What do these five numbers add up to?   "
},
{
...
},
{
  ...
  "type": "Activity",
  "number": "2.1.1",
  "title": "An election game.",
  "body": " An election game   The candidates have the information given in about how they would likely fare in the election based on how they stand on the speed limit.   Percentage of the vote for the speed limit issue.      Bainbridge      Raise Limit  Keep Limit  Dodge     Raise Limit       Arnold  Keep Limit        Dodge        Explain why is a zero-sum game.  What should Arnold choose to do? What should Bainbridge choose to do? Be sure to explain each candidate's choice. And remember, a player doesn't just want to win, he wants to get the MOST votes. For example, you could assume these are polling numbers and that there is some margin of error, thus a candidate prefers to have a larger margin over his opponent.  What is the outcome of the election? What percentage of the vote does each candidate get?  Does Arnold need to consider Bainbridge's strategies in order to decide on his own strategy? Does Bainbridge need to consider Arnold's strategies in order to decide on his own strategy? Explain your answer.  "
},
{
  "id": "A_election2",
  "level": "2",
  ...
  "body": " A new scenario   Bainbridge's mother is injured in a highway accident caused by speeding. The new payoff matrix is given in .   Percentage of the vote for the new scenario.      Bainbridge      Raise Limit  Keep Limit  Dodge     Raise Limit       Arnold  Keep Limit        Dodge        Explain why is a zero-sum game.  What should Arnold choose to do? What should Bainbridge choose to do? Be sure to explain each candidate's choice.  What is the outcome of the election? Give the payoff vector.  Does Arnold need to consider Bainbridge's strategies in order to decide on his own strategy? Does Bainbridge need to consider Arnold's strategies in order to decide on his own strategy? Explain your answer.  "
},
{
  "id": "A_election3",
  "level": "2",
  ...
  "body": " A third scenario   Bainbridge begins giving election speeches at college campuses and monster truck rallies. The new payoff matrix is given in .   Percentage of the vote for the third scenario.      Bainbridge      Raise Limit  Keep Limit  Dodge     Raise Limit       Arnold  Keep Limit        Dodge        Explain why is a zero-sum game.  What should Arnold choose to do? What should Bainbridge choose to do? Be sure to explain each candidate's choice.  What is the outcome of the election? Give the payoff vector.  Does Arnold need to consider Bainbridge's strategies in order to decide on his own strategy? Does Bainbridge need to consider Arnold's strategies in order to decide on his own strategy? Explain your answer.  "
},
{
  "id": "A_changestrategy",
  "level": "2",
  ...
  "body": " Changing the strategy   In each of the above scenarios, is there any reason for Arnold or Bainbridge to change his strategy from the strategy you determined? If there is, explain under what circumstances it makes sense to change strategy. If not, explain why it never makes sense to change strategy.   "
},
{
  "id": "D_equilpair",
  "level": "2",
  ...
  "number": "2.1.12",
  "title": "",
  "body": "equilibrium pair equilibrium   A pair of strategies is an equilibrium pair if neither player gains by changing strategies.   "
},
{
  "id": "SS_equilpairs-5",
  "level": "2",
  ...
  "type": "Table",
  "number": "2.1.13",
  "title": "Payoff matrix for Activity 1.2.2.",
...
},
{
  "id": "SS_equilpairs-9",
  "level": "2",
  "url": "S_IntroZeroSum.html#SS_equilpairs-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Rock, paper, scissors   Consider the game Rock-Paper-Scissors Rock-Paper-Scissors game Rock-Paper-Scissors (Rock beats Scissors, Scissors beat Paper, Paper beats Rock). Construct the payoff matrix for this game. Does it have an equilibrium pair? Explain your answer.   "
},
{
  "id": "A_network",
  "level": "2",
...
},
{
  ...
  "number": "2.1.3.3",
  "title": "",
  "body": "Determine which payoff vector is an equilibrium point for the following matrix.     is not an equilibrium point since if Player 2 chose column 1, Player 1 prefers row 2 with a payoff of 3. Similarly, if Player 1 chose row 1, Player 2 prefers column 2 with a payoff of .   is not an equilibrium point since if Player 2 chose column 2, Player 1 prefers row 2 with a payoff of 2. Note, Player 2 doesn't want to switch, but we only need one player to want to change strategies for the vector to not be an equilibrium.   is not an equilibrium point since if Player 1 chose row 2, Player 2 prefers column 2 with a payoff of . Note, Player 1 doesn't want to switch, but we only need one player to want to change strategies for the vector to not be an equilibrium.   is an equilibrium point since if Player 2 chose column 2, Player 1 does not prefer row 1 with a payoff of 0. Similarly, if Player 1 chose row 2, Player 2 does not prefer column 1 with a payoff of .   "
},
{
...
},
{
  ...
  "body": " A Simpler Payoff Matrix   Consider the zero-sum game with payoff matrix in . For simplicity our payoff matrix contains only the payoffs and not the strategy names; but Player 1 still chooses a row and Player 2 still chooses a column.   The payoff matrix for .     Player 2    Player 1            If we know we are playing a zero-sum game, then the use of ordered pairs seems somewhat redundant: if Player 1 wins 1, then we know that Player 2 must lose 1 (win ). Thus, if we KNOW we are playing a zero-sum game, we can simplify our notation by just using Player 1's payoffs. The above matrix in can be simplified as in .   The payoff matrix for using only Player 1's payoffs.     Player 2    Player 1             "
},
{
  "id": "T_smallexampleP2",
  "level": "2",
  ...
  "body": " The payoff matrix for using only Player 2's payoffs.     Player 2    Player 1           "
},
{
  "id": "E_domstrat2",
  "level": "2",
  ...
  "body": " A Game   Consider the zero-sum game given in .   Payoff matrix for .     Player 2    Player 1              Determine which row Player 1 should choose. Is there any situation in which Player 1 would choose the other row?   "
},
{
  "id": "E_domstrat3",
  "level": "2",
  ...
  "body": " Another Game   Consider the zero-sum game given in .   Payoff matrix for .     Player 2    Player 1              Determine which row Player 1 should choose. Is there any situation in which Player 1 would choose the other row?   "
},
{
...
},
{
  "id": "D_dominates",
  "level": "2",
  "url": "S_DominatedStrategies.html#D_dominates",
  "type": "Definition",
  "number": "2.2.9",
  "title": "",
  "body": "dominates dominated by dominated strategy strategy dominated   A strategy  dominates a strategy if every entry for is greater than or equal to the corresponding entry for . In this case, we say is dominated by  .  If strategy dominates strategy , we can write .   "
},
{
  "id": "F_strikerow2Ex2",
  "level": "2",
  ...
  "number": "2.2.10",
  "title": "",
  "body": " Row 2 is dominated by Row 1.   the game matrix from the example with a line through the second row    "
},
{
  "id": "F_strikecol3Ex3",
  "level": "2",
  ...
  "number": "2.2.11",
  "title": "",
  "body": " Column 3 is dominated by Column 2.   the game matrix from the example with a line through the second column    "
},
{
  "id": "F_strikerow2Ex3",
  "level": "2",
  ...
  "number": "2.2.12",
  "title": "",
  "body": " After eliminating Column 3, Row 2 is dominated by Row 1.   the game matrix from the example with a line through the second row and a line through the second column    "
},
{
  "id": "A_checkequilpair",
  "level": "2",
...
{
  "id": "elimdomstrategies-3",
  "level": "2",
  "url": "S_DominatedStrategies.html#elimdomstrategies-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Determine equilibrium pairs   Determine any equilibrium pairs in the zero-sum game given in . Explain all the steps in your solution. If you are unable to find an equilibrium pair, explain what goes wrong.   Payoff matrix for .      Player 2      W  X  Y  Z     A        Player 1  B         C         D          "
},
{
  ...
  "body": " Practice finding equilibrium pairs   Determine any equilibrium pairs in the zero-sum game given in . Explain all the steps in your solution. If you are unable to find an equilibrium pair, explain what goes wrong.   Payoff matrix for .      Player 2      W  X  Y  Z     A        Player 1  B         C         D          "
},
{
  ...
  "body": " A more challenging example   Determine any equilibrium pairs in the zero-sum game given in . Explain all the steps in your solution. If you are unable to find an equilibrium pair, explain what goes wrong.   Payoff matrix for .      Player 2      W  X  Y  Z     A        Player 1  B         C         D          "
},
{
  "id": "A_intromaxmin",
  "level": "2",
...
},
{
  ...
  "type": "Activity",
  "number": "2.2.10",
  "title": "The new method and equilibrium points.",
  "body": " The new method and equilibrium points   What do you notice about using this method on the games in , , and ? Is the solution an equilibrium pair?   "
},
{
...
{
  "id": "maximinstrategy-5",
  "level": "2",
  "url": "S_DominatedStrategies.html#maximinstrategy-5",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "maximinstrategy-6",
  "level": "2",
  "url": "S_DominatedStrategies.html#maximinstrategy-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "maximin\/minimax "
},
{
  ...
  "body": " Look for dominated strategies   Let's consider another game matrix, given in . Explain why you cannot use dominated strategies to find an equilibrium pair. Do you think there is an equilibrium pair for this game (why or why not)?   Payoff matrix for .      Player 2      W  X  Y  Z     A        Player 1  B         C         D          "
},
{
...
},
{
  ...
  "body": " Comparing examples   Compare the game in to what happens in , , and . Can you identify any key differences between the games in and , , and ?   "
},
{
...
},
{
  ...
  "number": "2.2.4.8",
  "title": "",
  "body": "  True or False: The game , has an equilibrium pair.  Try using what you know about the maximin and minimax strategies. False This game does not have an equilibrium pair. False.  "
},
{
...
},
{
  ...
  "number": "2.2.4.11",
  "title": "",
  "body": " Consider the game given in the table.     Player 2    Player 1                     The value of the maximin strategy for Player 1 is .  The value of the minimax strategy for Player 2 is .  These two values are equal ( yes or no ) .      1 is the largest of the smallest values in each row.      This is the largest value in the matrix, but not the largest of the minimum values from each row.      This is the smallest of the minimum values. We want the largest.      Incorrect.        1 is the smallest of the largest values in each column.      This is the smallest value in the matrix, but not the smallest of the maximum values from each column.      This is the largest value of the maximum values. We want the smallest.      Incorrect.        The maximin and the minimax values are equal.      The maximin and the minimax values are equal.      Your answer should be yes or no .     1, 1, yes  "
},
{
...
},
{
  ...
  "number": "2.3.1",
  "title": "",
  "body": "probability  The probability of an event is the number of different outcomes resulting in divided by the total number of equally likely outcomes. In mathematical symbols,  "
},
{
  "id": "E_drawheart",
  "level": "2",
...
},
{
  ...
  "number": "2.3.4",
  "title": "",
  "body": "expected value   The expected value of a game of chance is the average net gain or loss that we would expect per game if we played the game many times. We compute the expected value by multiplying the value of each outcome by its probability of occurring and then add up all of the products.   "
},
{
  "id": "E_expvalcalc",
  "level": "2",
  "url": "S_Probability.html#E_expvalcalc",
  "type": "Example",
  "number": "2.3.5",
  "title": "Calculating Expected Value.",
  "body": "Calculating Expected Value Suppose you toss a fair coin. If it lands on Heads, you win 25 cents. If it lands on Tails, you lose 25 cents. The probability of getting Heads is , as is the probability of getting Tails. The expected value of the game is   Thus, you would expect an average payoff of $0, if you were to play the game several times. Note, the expected value is not necessarily the actual value of playing the game. "
},
{
  "id": "A_Toss2coins",
  "level": "2",
...
{
  "id": "SS_expectedvalue-10",
  "level": "2",
  "url": "S_Probability.html#SS_expectedvalue-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "fair "
...
},
{
  ...
  "number": "2.3.3.8",
  "title": "",
  "body": "A game of chance is fair if the expected value is    A fair game has expected value of 0.  positive.  If the expected value is positive then the game is in the player's favor.  negative.  If the expected value is negative then the game is not in the player's favor.   "
},
{
  "id": "S_OneCardStud",
  "level": "1",
...
},
{
  ...
  "type": "Activity",
  "number": "2.4.4",
  "title": "Effect of the deal.",
  "body": " Effect of the deal   Does the actual deal affect the choice of strategy?   "
},
{
...
},
{
  ...
  "number": "2.4.5",
  "title": "",
  "body": "True or False: The actual payoff to a player in One-Card Stud Poker is the same as the expected payoff. In a game of chance the actual outcome is often different than the expected outcome. As the game is played more, the actual payoff approaches the expected payoff. False.  "
},
{
  "id": "S_EquilibPoints",
  "level": "1",
...
},
{
  ...
  "body": "Experimenting with different values  Let's see if we can create a matrix for a zero-sum game that has two equilibrium points with different values. Let's assume the two equilibria are and .  Create a matrix with and in the same row. Can they both be equilibria, or does one player want to switch?  Create a matrix with and in the same column. Can they both be equilibria, or does one player want to switch?  Now place and diagonally in the matrix (different rows and columns). Try to fill in values for the other two places in the matrix so that is an equilibrium. Is an equilibrium in any of your examples? Remember, if is an equilibrium, then must be the biggest value for Player 1 in the column and is the smallest in the row, so that is the biggest for Player 2 in the row.  Do you think it is possible to have both and be equilibrium points in a matrix? Explain your answer based on your examples.  "
},
{
  "id": "T_STfZSG",
  "level": "2",
...
},
{
  ...
  "number": "2.5.6",
  "title": "",
  "body": "True or False: In the matrix both payoff vectors are equilibria. Only the vector in Row 2, Column 1 is an equilibrium. False.  "
},
{
  ...
  "number": "2.5.7",
  "title": "",
  "body": "True or False: If is an equilibrium in a zero-sum game, then every payoff vector is an equilibrium. See . False.  "
},
{
...
},
{
  ...
  "body": " Classify examples   Now combine all the examples of payoff matrices in a group of 3 or 4 students. Make a list of the examples with equilibrium points and a list of examples without equilibrium points. If you have only one list, try generating examples for the other list. Based on your lists, do you think random payoff matrices are likely to have equilibrium points?   "
},
{
  "id": "A_playequil",
  "level": "2",
...
},
{
  ...
  "type": "Activity",
  "number": "2.6.4",
  "title": "Equilibria and maximin\/minimax.",
  "body": " Equilibria and maximin\/minimax   If a matrix has an equilibrium point, does the maximin\/minimax strategy always find it? Explain.   "
},
{
  "id": "A_noequilmaxmin",
  "level": "2",
...
{
  "id": "S_PopRationality-10",
  "level": "2",
  "url": "S_PopRationality.html#S_PopRationality-10",
  "type": "Question",
  "number": "2.7.2",
  "title": "",
...
{
  "id": "S_PopRationality-16",
  "level": "2",
  "url": "S_PopRationality.html#S_PopRationality-16",
  "type": "Question",
  "number": "2.7.6",
  "title": "",
...
{
  "id": "S_PopRationality-17",
  "level": "2",
  "url": "S_PopRationality.html#S_PopRationality-17",
  "type": "Question",
  "number": "2.7.7",
  "title": "",
  "body": " Think of other films where two characters engage in a game. What are the assumptions of the players? Do they have perfect information? Does the amount of information a player has give him or her an advantage? Explain.  "
},
{
  "id": "S_PopRationality-18",
  "level": "2",
  "url": "S_PopRationality.html#S_PopRationality-18",
  "type": "Question",
  "number": "2.7.8",
  "title": "",
...
{
  "id": "S_PopRationality-19",
  "level": "2",
  "url": "S_PopRationality.html#S_PopRationality-19",
  "type": "Question",
  "number": "2.7.9",
  "title": "",
  "body": "Find a news article that describes a political or economic situation as being a zero-sum game. Do you agree that the situation is a zero-sum game? Discuss how viewing the situation as a zero-sum game affects the behavior of the players. "
},
{
  "id": "S_IntroRepeated",
  "level": "1",
...
{
  "id": "S_IntroRepeated-5",
  "level": "2",
  "url": "S_IntroRepeated.html#S_IntroRepeated-5",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "strategy "
},
{
  ...
  "number": "3.1.1",
  "title": "",
  "body": "pure strategy strategy pure   In a repeated game, if a player always plays the same row or column, we say that she is playing a pure strategy .   "
},
{
  "id": "S_IntroRepeated-7",
  "level": "2",
  "url": "S_IntroRepeated.html#S_IntroRepeated-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "3.1.2",
  "title": "",
  "body": "mixed strategy strategy mixed   If a player varies which row or column he plays, then we say he is playing a mixed strategy .   "
},
{
  "id": "E_repeatequil",
  "level": "2",
...
{
  "id": "S_IntroRepeated-13",
  "level": "2",
  "url": "S_IntroRepeated.html#S_IntroRepeated-13",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "expected value "
},
{
  ...
  "body": " RPS payoff matrix  Consider the game of Rock-Paper-Scissors.   Construct a game matrix for Rock-Paper-Scissors.    Is Rock-Paper-Scissors a zero-sum game? Does it have an equilibrium point? Explain.   "
},
{
  "id": "A_RPSplay",
  "level": "2",
...
},
{
  ...
  "body": " Testing the random strategy  Let's try out the Random strategy  If Player 1 plays the Random strategy, what do you predict the long term payoff will be for Player 1? Does it matter what Player 2 plays? What is Player 2's long term payoff against the Random strategy?   Let's check our prediction. Using a die, let 1 and 2 represent Rock, 3 and 4 represent Paper, and 5 and 6 represent Scissors. Play the game 20 times with someone in class where each player rolls to determine the choice of Rock, Paper, or Scissors. Keep track of the strategy pairs and payoffs. What was the total payoff for each player? At this point, if you still feel that you have a better strategy, try your strategy against the random one to see what happens.   How did the actual outcome compare to your predicted outcome? What do you expect would happen if you play the game 100 times? (Or more?)  "
},
{
...
},
{
  ...
  "number": "3.1.4",
  "title": "",
  "body": "True or False: The following game has an equilibrium  For each outcome, at least one player wants to switch. False. "
},
{
...
},
{
  ...
  "number": "3.1.7",
  "title": "",
  "body": "True or False: The following game has an equilibrium  is an equilibrium. True. "
},
{
...
},
{
  ...
  "body": " Example matrix with named strategies     C  D    A      B      "
},
{
  ...
  "body": " Conjecture a strategy   First it is good to test your instinct. Do you think Player 1 should play one of the strategies more often than the other? If so, which strategy should she play the most?   "
},
{
  ...
  "number": "3.2.2",
  "title": "",
  "body": " Labeled axes.   horizontal and vertical axes where the x=0 value is labeled A and the x=1 value is labeled B    "
},
{
  ...
  "number": "3.2.3",
  "title": "",
  "body": " Player 2's strategy C .   horizontal and vertical axes where the x=0 value is labeled A and the x=1 value is labeled B; there is a line segment labeled C connecting the two points (0, 1) and (1, -1)    "
},
{
  ...
  "number": "3.2.4",
  "title": "",
  "body": " Player 2's strategy D .   horizontal and vertical axes where the x=0 value is labeled A and the x=1 value is labeled B; there is a line segment labeled C connecting the two points (0, 1) and (1, -1); there is a line segment labeled D connecting the points (0, 0) and (1, 2)    "
},
{
  "id": "F_BoldA",
  "level": "2",
  ...
  "number": "3.2.5",
  "title": "",
  "body": " of the expected payoffs for Player 1 playing only A.   horizontal and vertical axes where the x=0 value is labeled A and the x=1 value is labeled B; there is a line segment labeled C connecting the two points (0, 1) and (1, -1); there is a line segment labeled D connecting the points (0, 0) and (1, 2); the portion of the vertical axis is shaded red from (0, 0) to (0, 1)    "
},
{
  "id": "F_BoldHalf",
  "level": "2",
  ...
  "number": "3.2.6",
  "title": "",
  "body": " The expected payoffs for Player 1 playing B half the time.   horizontal and vertical axes where the x=0 value is labeled A and the x=1 value is labeled B; there is a line segment labeled C connecting the two points (0, 1) and (1, -1); there is a line segment labeled D connecting the points (0, 0) and (1, 2); there is a red vertical line segment at x=0.5 between line C and line D    "
},
{
...
},
{
  ...
  "number": "3.2.7",
  "title": "",
  "body": " The minimum expected payoffs for Player 1.   horizontal and vertical axes where the x=0 value is labeled A and the x=1 value is labeled B; there is a line segment labeled C connecting the two points (0, 1) and (1, -1); there is a line segment labeled D connecting the points (0, 0) and (1, 2); where a part of a line segment lies below the other line segment the lines are shaded red    "
},
{
  "id": "A_showminimax",
  "level": "2",
  ...
  "body": " The minimax strategy  We can use a graph to see the payoff for Player 2's minimax strategy.   Sketch the graph for Player 1 that we drew in . Be sure to label the endpoints of each line. Also label each line according to which strategy they represent.    Describe the minimax strategy and show it on the graph. (You do not need to find the actual mixed strategy for Player 2.)    Are the payoff vectors for the maximin and minimax strategies the same?   "
},
{
...
},
{
  ...
  "body": " Player 1 plays   Continue to use the game matrix in . Assume Player 1 only plays .  If Player 2 only plays , what is the payoff to Player 1? Recall we called this . What is the probability that Player 2 plays ? Recall we called this . On your graph, plot the point ( , ).  If Player 2 plays only , find and . Plot on the graph.  Now sketch the line through your two points. This line represents Player 1's pure strategy and the expected payoff (to Player 1) for Player 2's mixed strategies. Label it .  "
},
{
  "id": "A_graphP1B",
  "level": "2",
  ...
  "body": " Player 1 plays   Continue to use the game matrix in . Now assume Player 1 plays only . Repeat the steps in , using instead of , to find the line representing Player 1's pure strategy . (Label it!)   "
},
{
  "id": "A_graphminimax",
  "level": "2",
...
},
{
  ...
  "body": " The point of intersection   Find the equations of the lines you drew in and .    Using the equations from (a), find the point of intersection of the two lines.    How often should Player 2 play ? How often should he play ? What is Player 1's expected payoff? And hence, what is Player 2's expected payoff?   "
},
{
  "id": "A_whyequil",
  "level": "2",
...
},
{
  ...
  "number": "3.2.11",
  "title": "Fairness.",
  "body": " Fairness   Is the game in fair? Explain.   "
},
{
  "id": "A_graphexplainEV",
  "level": "2",
...
},
{
  ...
  "number": "3.2.1",
  "title": "",
  "body": "True or False: The following zero-sum game     C  D    A      B       has a pure strategy equilibrium. False. "
},
{
...
},
{
  ...
  "number": "3.2.4",
  "title": "",
  "body": "The line between two points and has slope and intercept .      Correct. Since the slope is       Incorrect. The slope is         Correct. Since the coordinate of is .      Incorrect. Find the coordinate of .    slope= , intercept= "
},
{
...
},
{
  ...
  "body": " Using Sage to Graph Lines and Solve Equations Sage  solution using Sage  In this section we will use technology to graph lines and solve for the intersection point. In particular, we will use an open online resource called Sage . Although you will be able to use Sage directly in the online version of textbook, you can access it externally by going to the Sage Cell Server at . This is free and open to use, no account needed. If you are working from the print version of the text you can just type the code into a Sage cell.  Let's continue to consider the game from given by  Small Repeated Game.     C  D    A      B        Recall, our goal is to determine how often Player 1 should play A and how often she should play B.  We will follow the same steps as in . Let be the probability that Player 1 plays B. Let be the payoff to Player 1. Since we are trying to find a mixed strategy for Player 1, we will pick a strategy for Player 2 and try to determine the possible payoffs for Player 1.  Let us determine some pairs .    Step 1. Assume Player 2 plays pure strategy C     Step 1a. Assume Player 1 plays pure strategy A  If Player 1 always plays , then we are considering the strategy pair . Since Player 1 never plays , . The payoff to Player 1 for is . Thus, for the strategy pair we get .   Step 1b. Assume Player 1 plays pure strategy B  If Player 1 always plays , then we are considering the strategy pair . Since Player 1 always plays , . The payoff to Player 1 for is . Thus, for the strategy pair we get .   Step 1c. Player 1 varies her strategy  Now we want to know what Player 1's payoff will be as she varies the probability, , with which she plays . We can draw a graph where the -axis represents the probability with which she plays B ( ) and the -axis represents the expected payoff ( ). Thus, when Player 1 plays only , she is playing with probability 0; when Player 1 plays only B, she is playing B with probability 1. It might be easier to remember if you label your graph as in .   Step 1d. Plot points  Now we can use Sage to plot the points we determined in Step 1a and Step 1b and the line between them. This line represents Player 2's pure strategy . See . Click on the Evaluate (Sage) button to plot the line between the points and .    Before moving on, let's again, make sure we understand what this line represents. Any point on it represents the expected payoff to Player 1 as she varies her strategy, assuming Player 2 only plays . In this case, we can see that as she plays more often, her expected payoff goes down. You can now use this Sage cell to plot any line for Player 2's pure strategy . Just edit the values for the points and . Go ahead and try it!  Now let's do the same thing, assuming Player 2 plays only .    Step 2. Assume Player 2 plays pure strategy D     Step 2a. Assume Player 1 plays pure strategy A  If Player 1 always plays , then we are considering the strategy pair . Since Player 1 never plays , . The payoff to Player 1 for is . Thus, for the strategy pair we get .   Step 2b. Assume Player 1 plays pure strategy B  If Player 1 always plays , then we are considering the strategy pair . Since Player 1 always plays , . The payoff to Player 1 for is . Thus, for the strategy pair we get .   Step 2c. Player 1 varies her strategy  Now, on our same graph from Step 1, we can plot the points we determined in Step 2a and Step 2b. We will connect them with a line representing Player 2's pure strategy . See .   We can see that if Player 2 plays only , then Player 1 does best by playing only . Again, you can use this Sage cell to plot both Player 2's pure strategies. Points and are for strategy , while points and are for strategy .   As we saw in , for each choice of , the top line represents the highest expected value for Player 1; the bottom line represents the lowest expected value for Player 1; the area between the lines represents the possible expected values for Player 1. Thus, Player 1 wants to maximize the minimum expected value, which means she wants to find the maximin strategy maximin strategy repeated games . And, as we saw in , the maximin strategy occurs at the intersection of the two lines.     Step 3. Find the intersection of the two lines     Step 3a. Find the equation for Line C  This is the line passing through the points and . It has slope and -intercept 1. Thus, it has equation . (Recall the -axis represents probability and the -axis represents expected payoff .)   Step 3b. Find the equation for Line D  This is the line passing through the points and . It has slope and -intercept 0. Thus, it has equation .   Step 3c. Use technology to find the point of intersection    The solution for Player 1 is . Where is the probability Player 1 plays B, and is the expected payoff to Player 1.  We can use this Sage cell to solve for and for any game by editing the equations .   Step 4. Determine Player 1's maximin mixed strategy maximin mixed strategy strategy maximin mixed  Determine Player 1's maximin mixed strategy. Recalling that is the probability that Player 1 plays , we know that Player 1 will play with probability 1\/4, and thus, play A with probability 3\/4. The expected payoff for Player 1, , is 1\/2. It is important to check the algebraic solution with where the intersection point appears on the graph. Although we are using technology to help us graph and solve for the intersection point, we need to be able to catch any errors we make entering the information into Sage .   We have seen that we can use the same matrix with Player 1's payoffs to find the strategy for Player 2. Using the same game matrix as above: and continuing to label Player 1's strategies by and , and Player 2's strategies by and , we can graph lines for Player 1's pure strategies and . We now let the -axis represent the probability that Player 2 plays . In the Sage applet below, for and enter the coordinates of two points that determine the line for when Player 1 plays , then the two points for and that determine the line for when Player 1 plays . We will then have Sage graph the lines. You can enter new values for and if you would like to draw the graph for a different matrix.    Now determine and enter the equations of the two lines and have Sage solve for the intersection point.    You can now these last two Sage cells to solve any 2 2 game with a mixed strategy equilibrium. You can also take some time to experiment with what happens if the game has a pure strategy equilibrium.  Sage is a powerful tool that we can use to solve many different computational problems. It is nice because it is free and open to use. But feel free to use other available graphing and solving tools, such as Desmos .  We can also use a simplified version of the interactive activity from .  Interactive Activity: Graphical Method    Now use the Sage cells or the interactive activity to help you analyze some more games!   Use technology to find a mixed strategy equilibrium   Consider the zero-sum game    Does this game have a pure strategy equilibrium?  Just by looking at the matrix, do you think this game will be fair? (Would you rather be Player 1 or Player 2?)  Use the Sage applet or the interactive activity to draw the graph for this game. Label each of your lines with the appropriate pure strategy.  Use your graph to determine if there is a mixed strategy equilibrium point. If there is, use technology to determine how often Player 1 should play each strategy. What is the expected payoff to each player?  Is this game fair? Explain. Compare your answer to (b).    More practice with technology   Consider the zero-sum game  Does this game have a pure strategy equilibrium?  Just by looking at the matrix, do you think this game will be fair? (Would you rather be Player 1 or Player 2?)  Use the Sage applet or the interactive activity to draw the graph for this game. Label each of your lines with the appropriate pure strategy.  Use your graph to determine if there is a mixed strategy equilibrium point. If there is, determine how often Player 1 should play each strategy. What is the expected payoff to each player?  Is this game fair? Explain. Compare your answer to (b).    Check Your Understanding  Use one of the tools in this section to find the mixed strategy for Player 1.  True or False: The following zero-sum game     C  D    A      B      has a pure strategy equilibrium. False.  Consider the zero-sum game given by . If we are finding Player 1's mixed strategy, which two points are on the line for Player 2's pure strategy C?   Player 2 is playing C, not D.  Correct.  Player 2 is playing C, not D.  Check the probability with which Player 1 is playing B.  Correct.  Player 2 is playing C, not D.  Check the probability with which Player 1 is playing A.  Player 2 is playing C, not D.   Consider the zero-sum game given by . If we are finding Player 1's mixed strategy, which two points are on the line for Player 2's pure strategy D?   Check the probability with which Player 1 is playing B.  Player 2 is playing D, not C.  Correct.  Player 2 is playing D, not C.  Player 2 is playing D, not C.  Correct.  Player 2 is playing D, not C.  Check the probability with which Player 1 is playing A.   The line between the points and has slope and intercept .      Correct. Since the slope is       Incorrect. The slope is         Correct. Since the coordinate of is .      Incorrect. Find the coordinate of .    slope= , intercept=  The line between the points and has slope and intercept .      Correct. Since the slope is       Incorrect. The slope is         Correct. Since the coordinate of is .      Incorrect. Find the coordinate of .    slope= , intercept=  True or False: When finding the mixed strategy, it is possible that is negative. Remember, is a probability. What is the smallest a probability can be?  True or False: When finding the mixed strategy, it is possible that is greater than 1. Remember, is a probability. What is the largest a probability can be? False.  Consider the zero-sum game given by . Find the mixed strategy for Player 1.   Remember in the intersection point is the probability that Player 1 plays B.  Correct. Player 1 should play A with a probability of and B with a probability of .  This is the intersection point, not the mixed strategy.   Consider the repeated zero-sum game given by . If Player 1 plays the maximin mixed strategy, her expected payoff is   Remember in the intersection point is the probability that Player 1 plays B.  Correct. The in the intersection point is the payoff to Player 1.  It depends on what Player 2 plays. The maximin strategy gives the same expected payoff no matter what Player 2 does.   Is the game in fair?   Yes. Think about the expected payoff of this game.  No, Player 1 has an advantage. Correct, since the expected payoff to Player 1 is positive.  No, Player 2 has an advantage. Incorrect, since the expected payoff to Player 1 is positive, the expected payoff to Player 2 is negative.  No, Player 1 has an advantage.  Find the mixed strategy for Player 1 for the following game.     C  D    A      B       Player 1 should play A with a probability of and B with a probability of . The expected payoff to Player 1 is .      Correct.      Incorrect. Work through the process carefully.        Correct.      Incorrect. Make sure your your probabilities sum to 1.        Correct.      Incorrect.     Find the mixed strategy for Player 2 for the game in .  Player 2 should play C with a probability of and D with a probability of . The expected payoff to Player 2 is . (Use 3 decimal places if necessary.)      Correct.      Make sure to round up.      Incorrect. Work through the process carefully.        Correct.      Incorrect. Make sure your your probabilities sum to 1.        Correct.      Make sure to round up.      Should Player 2's payoff be positive?      Incorrect.     If we use the graphical method to try to find Player 1's mixed strategy, which of the following can we determine with just the graph, without solving for the intersection point?   Whether Player 1 should play A more often than B. If the intersection seems to be closer to than , then Player 1 should play A more often than B.  Whether Player 2 should play C more often than D. We can't determine Player 2's mixed strategy from Player 1's graph.  Whether Player 1's expected payoff is positive or negative. If the intersection point is above the -axis, then the payoff is positive.  Whether Player 2's expected payoff is positive or negative. If the intersection point is above the -axis, then the payoff to Player 1 is positive, hence the payoff to Player 2 is negative.  Whether Player 1 will win or lose if the game is played once. We are finding the expected payoff. The actual payoff will depend on what each player plays in one game.  Whether Player 1 will win or lose if the game is played 10 times. We are finding the expected payoff. The actual payoff will depend on what each player plays over the 10 games.  The three correct answers are: whether Player 1 should play A more often than B; whether Player 1's expected payoff is positive or negative; and whether Player 2's expected payoff is positive or negative.   "
},
{
  "id": "S_SolvingEq-5-2",
  "level": "2",
  "url": "S_SolvingEq.html#S_SolvingEq-5-2",
  "type": "Table",
  "number": "3.3.1",
  "title": "Small Repeated Game.",
  "body": " Small Repeated Game.     C  D    A      B      "
},
{
  ...
  "type": "Activity",
  "number": "3.3.1",
  "title": "Use technology to find a mixed strategy equilibrium.",
  "body": " Use technology to find a mixed strategy equilibrium   Consider the zero-sum game    Does this game have a pure strategy equilibrium?  Just by looking at the matrix, do you think this game will be fair? (Would you rather be Player 1 or Player 2?)  Use the Sage applet or the interactive activity to draw the graph for this game. Label each of your lines with the appropriate pure strategy.  Use your graph to determine if there is a mixed strategy equilibrium point. If there is, use technology to determine how often Player 1 should play each strategy. What is the expected payoff to each player?  Is this game fair? Explain. Compare your answer to (b).  "
},
{
  ...
  "type": "Activity",
  "number": "3.3.2",
  "title": "More practice with technology.",
  "body": " More practice with technology   Consider the zero-sum game  Does this game have a pure strategy equilibrium?  Just by looking at the matrix, do you think this game will be fair? (Would you rather be Player 1 or Player 2?)  Use the Sage applet or the interactive activity to draw the graph for this game. Label each of your lines with the appropriate pure strategy.  Use your graph to determine if there is a mixed strategy equilibrium point. If there is, determine how often Player 1 should play each strategy. What is the expected payoff to each player?  Is this game fair? Explain. Compare your answer to (b).  "
},
{
  "id": "IGT_SE_CYU_equil",
  "level": "2",
...
},
{
  ...
  "number": "3.3.6",
  "title": "",
  "body": "True or False: When finding the mixed strategy, it is possible that is negative. Remember, is a probability. What is the smallest a probability can be? "
},
{
  "id": "IGT_SE_CYU_pgt1",
  "level": "2",
  ...
  "number": "3.3.7",
  "title": "",
  "body": "True or False: When finding the mixed strategy, it is possible that is greater than 1. Remember, is a probability. What is the largest a probability can be? False. "
},
{
  ...
  "number": "3.3.8",
  "title": "",
  "body": "Consider the zero-sum game given by . Find the mixed strategy for Player 1.   Remember in the intersection point is the probability that Player 1 plays B.  Correct. Player 1 should play A with a probability of and B with a probability of .  This is the intersection point, not the mixed strategy.  "
},
{
...
},
{
  ...
  "number": "3.3.11",
  "title": "",
  "body": "Find the mixed strategy for Player 1 for the following game.     C  D    A      B       Player 1 should play A with a probability of and B with a probability of . The expected payoff to Player 1 is .      Correct.      Incorrect. Work through the process carefully.        Correct.      Incorrect. Make sure your your probabilities sum to 1.        Correct.      Incorrect.    "
},
{
...
},
{
  ...
  "number": "3.3.13",
  "title": "",
  "body": "If we use the graphical method to try to find Player 1's mixed strategy, which of the following can we determine with just the graph, without solving for the intersection point?   Whether Player 1 should play A more often than B. If the intersection seems to be closer to than , then Player 1 should play A more often than B.  Whether Player 2 should play C more often than D. We can't determine Player 2's mixed strategy from Player 1's graph.  Whether Player 1's expected payoff is positive or negative. If the intersection point is above the -axis, then the payoff is positive.  Whether Player 2's expected payoff is positive or negative. If the intersection point is above the -axis, then the payoff to Player 1 is positive, hence the payoff to Player 2 is negative.  Whether Player 1 will win or lose if the game is played once. We are finding the expected payoff. The actual payoff will depend on what each player plays in one game.  Whether Player 1 will win or lose if the game is played 10 times. We are finding the expected payoff. The actual payoff will depend on what each player plays over the 10 games.  The three correct answers are: whether Player 1 should play A more often than B; whether Player 1's expected payoff is positive or negative; and whether Player 2's expected payoff is positive or negative. "
},
{
  "id": "S_MixStratEV",
  "level": "1",
  ...
  "body": " Mixed Strategies: Expected Value Solution mixed strategy expected value solution expected value  expected value solution  solution expected value  maximin strategy expected value solution  In this section, we will use the idea of expected value to find the equilibrium mixed strategies for repeated two-person zero-sum games.  One of the significant drawbacks of the graphical solution from the previous sections is that it can only solve matrix games. If each player has 3 options, we would need to graph in three dimensions. Technically this is possible, but rather complicated. If each player has more than 3 options, since we can't graph in four or more dimensions, we are at a complete loss. So we need to think about an alternate way to solve for the mixed strategies. Although we will begin with games, this method will easily generalize to larger games.   Matching Pennies Game Matching Pennies game Matching Pennies    Consider the game in which each player can choose Heads (H) or Tails (T); if the two players match, Player 1 wins; if the two players differ, Player 2 wins. What strategy should each player play?     Payoff matrix for Matching Pennies  We want to determine what each player should do in the Matching Pennies game.   Determine the payoff matrix for the Matching Pennies game.    Explain why the Matching Pennies game has no pure strategy equilibrium point.     Conjecture a mixed strategy   Since we know that there is no pure strategy equilibrium point we need to look for a mixed strategy equilibrium point.  Just by looking at the payoff matrix for Matching Pennies, what do you think an ideal strategy for each player would be? Explain your choice.   Suppose both players play your ideal strategy in the Matching Pennies game, what should the expected value of the game be?    We could use our previous graphical method to determine the expected value of the game (you might try this just to verify your prediction). However, as we have noted, a major drawback of the graphical solution is that if our players have 3 or more options, then we would need to graph an equation in 3 or more variables; which, I hope you agree, we don't want to do. Although we will continue to focus on games, we will develop a new method which can more easily be used to solve larger games.  We will need some new notation. Let Also, we will let be the expected value for Player 1 playing pure strategy H against a given strategy for Player 2. Similarly, will be Player 2's expected value for playing pure strategy H.   The strategy for Player 2   In the Matching Pennies game, suppose Player 2 plays H 60% of the time and T 40% of the time.  What are and ?  What do you think Player 1 should do? Does this differ from your ideal mixed strategy in ? Explain.  We can use expected value to compute what Player 1 should do in response to Player 2's 60\/40 strategy. First, consider a pure strategy for Player 1. Compute the expected value for Player 1 if she only plays H while Player 2 plays H with probability and T with probability . This expected value is .  Similarly, compute the expected value for Player 1 if she plays only T. Call it .  Which pure strategy, H or T, has a higher expected value for Player 1? If Player 1 plays this pure strategy, will she do better than your predicted value of the game?    The strategy is not ideal for Player 2   Hopefully, you concluded that in a pure strategy is good for Player 1. Explain why this means the 60\/40 strategy is bad for Player 2.     When to play H, when to play T   For any particular mixed (or pure) strategy of Player 2, we could find and .  Explain why if Player 1 should always play H.  Similarly, explain why if Player 1 should always play T.   Explain why the situations in (a) and (b) are bad for Player 2.     Equal expected values are better   Use your answers from to explain why the situation in which is the best for Player 2.    From we now know that Player 2 wants , we can use a little algebra to compute the best defensive strategy for Player 2. Remember, we want to assume that Player 1 will always be able to chose the strategy that will be best for her, and thus Player 2 wants to protect himself. Let's find the probabilities with which Player 2 should play H and T.   Equations for Player 1's expected values   Let and be the probabilities that Player 2 plays H and T respectively.  Find equations for and in terms of and for the game of Matching Pennies. The expected value, , is (Player 1's payoff for [H, H] (Player 1's payoff for [H, T] .  Since we want , set your two equations equal to each other. This gives you one equation in terms of and .  Explain why we must also have the equation .   In general, to solve for Player 2's strategy, we want to write an equation for each of Player 1's pure strategy expected values in terms of Player 2's probabilities. For example, and in terms of variables and . We then set the expected values equal to each other. We now have an equation just in terms of Player 2's probabilities.  In order to solve for the probabilities, we also need to use the fact that Player 2's probabilities sum to 1. For example, . For a game, you now have 2 equations with 2 unknowns ( and ). Use an algebraic method such as substitution or elimination to solve the system of equations.   Solve for Player 2's probabilities   Using the equations from solve for and . You now have the equilibrium mixed strategy for Player 2. Does this match the mixed strategy you determined in ?    Can you use a similar process to find Player 1's strategy? Whose expected values should you use? Whose probabilities?   Find Player 1's probabilities   Set up and solve the analogous equations from for Player 1. Does this match the mixed strategy from ?   We should have an equation for and one for . Since we are looking for the probabilities of each of Player 1's options, the equations should involve and .   We now have a new method for finding the best mixed strategies for Players 1 and 2, assuming that each player is playing defensively against an ideal player. But how can we find the value of the game? For Player 2, we assumed . In other words, we found the situation in which Player 1's expected value is the same no matter which pure strategy she plays. Thus, Player 1 is indifferent to which pure strategy she plays. If she were not indifferent, then she would play the strategy with a higher expected value. But, as we saw, this would be bad for Player 2. So Player 1 can assume that Player 2 will play the equilibrium mixed strategy. Thus, as long as Player 1 plays a mixed strategy, it doesn't matter whether at any given time, she plays H or T (this is the idea that she is indifferent to them). Hence, the expected value of the game for Player 1 is the same as , which is the same as . Similarly, we find that the expected value of the game for Player 2 is (or ). This is a pretty complicated idea. You may need to think about it for a while. In the meantime, use the probabilities you found for each player and the equations for and to find the value of the game for each player.   Find Player 1's expected value of the game   Use the probabilities you calculated in to find , and hence the expected value of the game for Player 1. How does this compare to your prediction for the value of the game that you gave in ?     Find Player 2's expected value of the game   Use the probabilities you calculated in to find , and hence the expected value of the game for Player 2. How does this compare to your prediction for the value of the game that you gave in ?    Keep practicing with the expected value method on some other games.   Solve a repeated game using expected values   Apply the method of using expected value to the game in to find the equilibrium mixed strategies for each player and the value of the game for each player: Note, we solved this game using the graphical method in , so you can compare your answer.     Expected value solution for Rock-Paper-Scissors Rock-Paper-Scissors expected value solution   As we noted in this section, teh expected value method can be used to solve bigger games. We just have more equations. Use the expected value method to find the equilibrium mixed strategy for Rock-Paper-Scissors for Player 2.   You will need to set and ; solve for ; etc. It should be very similar to what you did for Matching Pennies, but there will be three equations and three unknowns.   If you found this last activity to be algebraically challenging, don't worry, we will be able to use technology to help us solve equations with several variables.   Check Your Understanding  True or False: The following zero-sum game     C  D    A      B      has a pure strategy equilibrium. False.  Consider the zero-sum game given by . Suppose Player 2 plays the C 50% of the time and D 50% of the time. We can call this the strategy. What is ?       Correct, .      Incorrect. Make sure you are multiplying the payoffs by the probabilities.      Incorrect. Make sure you are finding the expected value for Player 1.      Incorrect. Remind yourself how to find the expected value. We are using Player 1's payoffs when playing A.       Consider the zero-sum game given by . Suppose Player 2 plays the C 50% of the time and D 50% of the time. We can call this the strategy. What is ?       Correct, .      Incorrect. Make sure you are multiplying the payoffs by the probabilities.      Incorrect. Make sure you are finding the expected value for Player 1.      Incorrect. Remind yourself how to find the expected value. We are using Player 1's payoffs when playing B.       Suppose Player 2 plays the strategy in , then which pure strategy does Player 1 prefer?   Playing A Use the expected values of each pure strategy to help you.  Playing B Use the expected values of each pure strategy to help you.  Neither, Player 1 is indifferent to playing A or B. Since the expected value for Player 1 is the same, Player 1 has no preference.  Neither  Consider the zero-sum game given by . Suppose Player 2 plays C 25% of the time and D 75% of the time. We can call this the or strategy. What is ?       Correct, .      Incorrect. Make sure you are finding the expected value for Player 1.      Incorrect. Make sure you are using the probabilities and and Player 1's payoffs when playing A.       Consider the zero-sum game given by . Suppose Player 2 plays C 25% of the time and D 75% of the time. We can call this the or strategy. What is ?   Reminder, if your answer is not a whole number, use decimals.      Correct, .      Incorrect. Make sure you are finding the expected value for Player 1.      Incorrect. Make sure you are using the probabilities and and Player 1's payoffs when playing B.       If Player 2 plays the strategy in , then which pure strategy does Player 1 prefer?   Playing A Use the expected values of each pure strategy to help you.  Playing B Since the expected value for Player 1 is greater for B than A, Player 1 prefers B.  Neither, Player 1 is indifferent to playing A or B. Use the expected values of each pure strategy to help you.  Playing B  Consider the zero-sum game given by . Suppose Player 2 plays the strategy.  What is ?  What is ?  Reminder, if your answer is not a whole number, use decimals.       Correct, .      Incorrect. Make sure you are using the probabilities and and Player 1's payoffs when playing A.        Correct, .      Incorrect. Make sure you are using the probabilities and and Player 1's payoffs when playing B.       If Player 2 plays the strategy in , then which pure strategy does Player 1 prefer?   Playing A Since the expected value for Player 1 is greater for A than B, Player 1 prefers A.  Playing B Use the expected values of each pure strategy to help you.  Neither, Player 1 is indifferent to playing A or B. Use the expected values of each pure strategy to help you.  Playing A  To find Player 1's equilibrium mixed strategy we use the expected values for and the probabilities for .   Player 1; Player 1 Player 1 wants Player 2's expected values to be equal.  Player 2; Player 2 Think about whose probabilities you want to find.  Player 1; Player 2 Think about whose probabilities you want to find.  Player 2; Player 1 We use and .  Player 2; Player 1  Which two equations should you use to find Player 1's equilibrium mixed strategy in the following game?     C  D    A      B         This is .  This is .  This uses that the probabilities must sum to 1.  This uses that the probabilities must sum to 1.  and  Which two equations should you use to find Player 2's equilibrium mixed strategy in the game ?   This is .  This is .  This uses that the probabilities must sum to 1.  This uses that the probabilities must sum to 1.  and   "
},
{
  ...
  "body": " Matching Pennies Game Matching Pennies game Matching Pennies    Consider the game in which each player can choose Heads (H) or Tails (T); if the two players match, Player 1 wins; if the two players differ, Player 2 wins. What strategy should each player play?   "
},
{
  "id": "A_mpmatrix",
  "level": "2",
  ...
  "type": "Activity",
  "number": "3.4.1",
  "title": "Payoff matrix for Matching Pennies.",
  "body": " Payoff matrix for Matching Pennies  We want to determine what each player should do in the Matching Pennies game.   Determine the payoff matrix for the Matching Pennies game.    Explain why the Matching Pennies game has no pure strategy equilibrium point.   "
},
{
  "id": "A_mpguess",
  "level": "2",
...
},
{
  ...
  "type": "Activity",
  "number": "3.4.3",
  "title": "The <span class=\"process-math\">\\((0.6, 0.4)\\)<\/span> strategy for Player 2.",
  "body": " The strategy for Player 2   In the Matching Pennies game, suppose Player 2 plays H 60% of the time and T 40% of the time.  What are and ?  What do you think Player 1 should do? Does this differ from your ideal mixed strategy in ? Explain.  We can use expected value to compute what Player 1 should do in response to Player 2's 60\/40 strategy. First, consider a pure strategy for Player 1. Compute the expected value for Player 1 if she only plays H while Player 2 plays H with probability and T with probability . This expected value is .  Similarly, compute the expected value for Player 1 if she plays only T. Call it .  Which pure strategy, H or T, has a higher expected value for Player 1? If Player 1 plays this pure strategy, will she do better than your predicted value of the game?  "
},
{
  "id": "A_mp60_40badP2",
  "level": "2",
  ...
  "type": "Activity",
  "number": "3.4.4",
  "title": "The <span class=\"process-math\">\\((0.6, 0.4)\\)<\/span> strategy is not ideal for Player 2.",
...
},
{
  ...
  "body": " When to play H, when to play T   For any particular mixed (or pure) strategy of Player 2, we could find and .  Explain why if Player 1 should always play H.  Similarly, explain why if Player 1 should always play T.   Explain why the situations in (a) and (b) are bad for Player 2.   "
},
{
  "id": "A_eqgood",
  "level": "2",
  ...
  "body": " Equal expected values are better   Use your answers from to explain why the situation in which is the best for Player 2.   "
},
{
  "id": "A_mpequations",
  "level": "2",
  ...
  "body": " Equations for Player 1's expected values   Let and be the probabilities that Player 2 plays H and T respectively.  Find equations for and in terms of and for the game of Matching Pennies. The expected value, , is (Player 1's payoff for [H, H] (Player 1's payoff for [H, T] .  Since we want , set your two equations equal to each other. This gives you one equation in terms of and .  Explain why we must also have the equation .  "
},
{
  "id": "A_mpsolve",
  "level": "2",
...
},
{
  ...
  "body": " Solve a repeated game using expected values   Apply the method of using expected value to the game in to find the equilibrium mixed strategies for each player and the value of the game for each player: Note, we solved this game using the graphical method in , so you can compare your answer.   "
},
{
  "id": "A_RPSEVsol",
  "level": "2",
  ...
  "body": " Expected value solution for Rock-Paper-Scissors Rock-Paper-Scissors expected value solution   As we noted in this section, teh expected value method can be used to solve bigger games. We just have more equations. Use the expected value method to find the equilibrium mixed strategy for Rock-Paper-Scissors for Player 2.   You will need to set and ; solve for ; etc. It should be very similar to what you did for Matching Pennies, but there will be three equations and three unknowns.  "
},
{
...
},
{
  ...
  "number": "3.4.4",
  "title": "",
  "body": "Suppose Player 2 plays the strategy in , then which pure strategy does Player 1 prefer?   Playing A Use the expected values of each pure strategy to help you.  Playing B Use the expected values of each pure strategy to help you.  Neither, Player 1 is indifferent to playing A or B. Since the expected value for Player 1 is the same, Player 1 has no preference.  Neither "
},
{
...
},
{
  ...
  "number": "3.4.7",
  "title": "",
  "body": "If Player 2 plays the strategy in , then which pure strategy does Player 1 prefer?   Playing A Use the expected values of each pure strategy to help you.  Playing B Since the expected value for Player 1 is greater for B than A, Player 1 prefers B.  Neither, Player 1 is indifferent to playing A or B. Use the expected values of each pure strategy to help you.  Playing B "
},
{
...
},
{
  ...
  "number": "3.4.9",
  "title": "",
  "body": "If Player 2 plays the strategy in , then which pure strategy does Player 1 prefer?   Playing A Since the expected value for Player 1 is greater for A than B, Player 1 prefers A.  Playing B Use the expected values of each pure strategy to help you.  Neither, Player 1 is indifferent to playing A or B. Use the expected values of each pure strategy to help you.  Playing A "
},
{
...
},
{
  ...
  "number": "3.4.11",
  "title": "",
  "body": "Which two equations should you use to find Player 1's equilibrium mixed strategy in the following game?     C  D    A      B         This is .  This is .  This uses that the probabilities must sum to 1.  This uses that the probabilities must sum to 1.  and "
},
{
...
},
{
  ...
  "number": "3.5.10",
  "title": "",
  "body": "If Player 2 plays the mixed strategy in Liar's Poker, then which pure strategy does Player 1 prefer?   Bluffing (B) Use the expected values of each pure strategy to help you.  Telling the truth (T) Since the expected value for Player 1 is greater for T than B, Player 1 prefers T.  Neither, Player 1 is indifferent to playing B or T. Use the expected values of each pure strategy to help you.  Telling the truth (T) "
},
{
...
},
{
  ...
  "number": "3.6.5",
  "title": "Using Sage.",
  "body": "Using Sage We can also find the reduced row echelon form of a matrix using Sage , as in the following Sage cell.  "
},
{
  "id": "A_2x2system1",
  "level": "2",
...
},
{
  ...
  "type": "Activity",
  "number": "3.6.6",
  "title": "A system with 5 equations.",
  "body": " A system with 5 equations   Consider the system of equations  Set up the augmented matrix for this system.  Use row reduction to find the solution.  "
},
{
...
},
{
  ...
  "number": "3.7.1",
  "title": "Undercut.",
  "body": " Undercut Undercut game Undercut   Each player chooses a number 1 through 5. If the two numbers don't differ by 1, then each player adds their own number to their score. If the two numbers differ by 1, then the player with the lower number adds both numbers to their score; the player with the higher number gets nothing. This game is from Douglas Hofstadter's Metamagical Themas , p. 700, .  For example, suppose in round one Player 1 chooses 4, and Player 2 chooses 4. Each player gets their own number of points. The score is now 4-4. In the next round, Player 1 chooses 2, and Player 2 chooses 5. The score would now be 6-9. In the third round Player 1 chooses 4, and Player 2 chooses 5. Now Player 1 gets both numbers, while Player 2 gets nothing, making the score 15-9.   "
},
{
  "id": "A_Uplay",
  "level": "2",
...
},
{
  "id": "S_Undercut-13",
  "level": "2",
  "url": "S_Undercut.html#S_Undercut-13",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "net gain "
...
},
{
  "id": "S_Undercut-19",
  "level": "2",
  "url": "S_Undercut.html#S_Undercut-19",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "symmetric "
...
},
{
  ...
  "body": " Expected value of a symmetric game   In , you should have determined that since this is a symmetric game, the expected value for each Player should be 0. Modify your equations from to include this piece of information. Note, we can ONLY do this since we know the game is symmetric!   "
},
{
  "id": "A_Usolve",
  "level": "2",
...
{
  "id": "IGT_UC_CYU_symmetric1",
  "level": "2",
  "url": "S_Undercut.html#IGT_UC_CYU_symmetric1",
  "type": "Reading Question",
  "number": "3.7.4",
  "title": "",
  "body": "True or False: The following zero-sum game is symmetric:  Player 1's payoffs always positive, while Player 2's are always negative. Thus the game is not symmetric. False. "
},
{
  "id": "IGT_UC_CYU_symmetric2",
  "level": "2",
  "url": "S_Undercut.html#IGT_UC_CYU_symmetric2",
  "type": "Reading Question",
  "number": "3.7.5",
  "title": "",
  "body": "True or False: The following zero-sum game is symmetric:  You can check that if wrote Player 2's payoff matrix with Player 2 as the row player, the matrix would be the same. True. "
},
{
  "id": "IGT_UC_CYU_symmetric3",
  "level": "2",
  "url": "S_Undercut.html#IGT_UC_CYU_symmetric3",
  "type": "Reading Question",
  "number": "3.7.6",
  "title": "",
  "body": "True or False: The following zero-sum game is symmetric:  When players play the same strategy (for example Row 1, Column 1), Player 1 wins. False. "
},
{
  "id": "IGT_UC_CYU_symmetric4",
  "level": "2",
  "url": "S_Undercut.html#IGT_UC_CYU_symmetric4",
  "type": "Reading Question",
  "number": "3.7.7",
  "title": "",
  "body": "True or False: The following zero-sum game is symmetric:  This game has a pure strategy equilibrium in which Player 1 wins 1. False. "
},
{
...
},
{
  ...
  "number": "3.7.15",
  "title": "",
  "body": "True or False: In Undercut, If Player 1 is playing the mixed strategy equilibrium, then Player 2 should play the mixed strategy equilibrium.  This is the main idea of an equilibrium, no player gains by changing strategy. True. "
},
{
  "id": "S_IntroNonzero",
  "level": "1",
...
},
{
  ...
  "number": "4.1.2",
  "title": "Not zero-sum.",
  "body": " Not zero-sum   Explain why Battle of the Movies is not a zero-sum game.   "
},
{
  "id": "A_BoMannounce",
  "level": "2",
...
},
{
  ...
  "body": " Repeating the game   Suppose Battle of teh Movies is played repeatedly. For example, Alice and Bob have movie night once a month.  Suggest a strategy for Alice and for Bob.  Play the game with someone else without communicating about your strategy before each game.   How could communication affect the choice of strategy? Now play several times where you are allowed to communicate about your strategy. Does this change your strategy?  In either case, communicating and not communicating, do you think your strategies for Alice and Bob represent a mixed strategy equilibrium?   "
},
{
  ...
  "body": " Compare to zero-sum   In a zero-sum game, if there is a pure strategy equilibrium, then what happens when you repeat a game? If you repeat Battle of the Movies, does the game always result in an equilibrium point?   "
},
{
...
},
{
  ...
  "number": "4.1.2",
  "title": "",
  "body": "The following game has at least one pure strategy equilibrium, click on or circle the equilibrium point(s).      C  D    A      B        "
},
{
...
},
{
  ...
  "number": "4.1.6",
  "title": "",
  "body": "The following game has at least one pure strategy equilibrium, click on or circle the equilibrium point(s).      C  D    A      B        and "
},
{
  ...
  "number": "4.1.7",
  "title": "",
  "body": "True or False: In the game in , if the players play once, and each player chooses the strategy with their preferred equilibrium, then the game will result in an equilibrium. Player 1 would play B while Player 2 would play C, which is not an equilibrium. False. "
},
{
...
},
{
  ...
  "number": "4.1.9",
  "title": "",
  "body": "In the game in , suppose Player 1 plays the zero-sum mixed strategy. Then Player 2 prefers to play   Pure strategy C. We can find and So, Player 2 prefers C.  Pure strategy D. Find and  A mixed strategy with C more often than D. Find and  A mixed strategy with D more often than C. Find and  Pure strategy C since and "
},
{
...
},
{
  ...
  "number": "4.1.11",
  "title": "",
  "body": "Going back to Battle of the Movies, suppose Alice still prefers Comedy to Action, but also prefers to go to the movie with Bob than to go alone. However, Bob hates Comedy, so he would prefer to see the action movie alone rather than go to the Comedy movie.  We can adjust the payoff as in the following matrix. Click or circle any equilibrium points.       Alice      Action  Comedy    Bob  Action       Comedy        "
},
{
  ...
  "number": "4.1.12",
  "title": "",
  "body": "True or False: In a zero-sum game , it can benefit a player to announce their strategy. Since one player's gain is the other's loss, it never benefits a player to announce a strategy. False. "
},
{
  ...
  "number": "4.1.13",
  "title": "",
  "body": "True or False: In a non-zero-sum game , it can benefit a player to announce their strategy. Think of Battle of the Movies and what Bob should do if Alice says she is going to Comedy. Would this benefit Alice? True. "
},
{
...
{
  "id": "S_PdandChicken-11",
  "level": "2",
  "url": "S_PdandChicken.html#S_PdandChicken-11",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "4.2.11",
  "title": "The dilemma.",
  "body": " The dilemma   Explain why Prisoner's Dilemma is a dilemma for the prisoners. Is it likely they will choose a strategy which leads to the best outcome for both? You might want to consider whether there are dominated strategies.   "
},
{
  "id": "E_Chicken",
  "level": "2",
...
},
{
  ...
  "number": "4.2.12",
  "title": "Dominated strategies.",
  "body": " Dominated strategies   Does the game of Chicken in have any dominated strategies?   "
},
{
  "id": "A_Cbestoutcome",
  "level": "2",
  ...
  "number": "4.2.13",
  "title": "The best outcome.",
  "body": " The best outcome   What strategy results in the best outcome for Driver 1? What strategy results in the best outcome for Driver 2? What happens if they both choose these strategies?   "
},
{
  "id": "A_Cequilpairs",
  "level": "2",
...
{
  "id": "S_PdandChicken-42",
  "level": "2",
  "url": "S_PdandChicken.html#S_PdandChicken-42",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Summary of responses  Create a summary of the responses from the class-wide experiment.  How many C's are there?  How many D's are there?  What is the payoff to each C?  What is the payoff to each D?  "
},
{
  "id": "A_CWPDmatrix",
  "level": "2",
  ...
  "number": "4.3.2",
  "title": "Payoff matrix.",
  "body": " Payoff matrix   Determine the payoff matrix for this game, which we can think of as a class-wide Prisoner's Dilemma.   Although you played this game with each other person in the class, this is still a 2 person game.  "
},
{
  "id": "A_CWPDreasons",
  "level": "2",
...
},
{
  ...
  "number": "4.3.1",
  "title": "",
  "body": "Consider the Class-Wide Prisoner's Dilemma described at the beginning of this section. What is the payoff vector if Player 1 cooperates and Player 2 defects?    See .  See .  See .  See .  See .  See .  "
},
{
...
},
{
  ...
  "body": " What Makes a Prisoner's Dilemma? Prisoner's Dilemma conditions  In this section we give a mathematical description of Prisoner's Dilemma and compare it to some similar games.  The Class-wide Prisoner's Dilemma game we played in has the payoff matrix given in for each pair of players.   A Class-wide Prisoner's Dilemma.      Player 2      Cooperate  Defect    Player 1  Cooperate       Defect       We can classify each of the values for the payoffs as follows:  Reward for Mutual Cooperation:   Punishment for Defecting:   Temptation to Defect:   Sucker's Payoff:     Conditions for a Prisoner's Dilemma  In order for a game to be a variation of Prisoner's Dilemma it must satisfy two conditions:            Description of conditions   Describe conditions (1) and (2) in in words.    is the average of and .   Let's apply this description of Prisoner's Dilemma to a few games we've seen. We can use to check if a game is really a Prisoner's Dilemma.   The conditions for Classwide Prisoner's Dilemma   Show the hold for the Class-wide Prisoner's Dilemma in .     The conditions for Prisoner's Dilemma   Recall the matrix for Prisoner's Dilemma from .   Prisoner's Dilemma (again).      Prisoner 2      Confess  Don't Confess    Prisoner 1  Confess       Don't Confess       Determine and for this game. Be careful, think about what cooperating versus defecting should mean. Show the are satisfied.   Time in jail is bad, so the bigger the number, the worse you do; thus, it might be helpful to think of the payoffs as negatives.    The conditions for Chicken   Recall the matrix for Chicken from .   Chicken (again).      Driver 2      Swerve  Straight    Driver 1  Swerve       Straight       Determine and for this game. Again, think about what cooperating and defecting mean in this game. Determine if the are satisfied. If not, which condition(s) fail?     The conditions on another game   Consider the cooperate-defect game where the first row\/column is C and the second row\/column is D:    Determine and for this game. Determine if the are satisfied. If not, which condition(s) fail?     A little more practice   Consider the cooperate-defect game where the first row\/column is C and the second row\/column is D:   Determine and for this game. Determine if are satisfied. If not, which condition(s) fail?     Compare the games   The games in , , and are not true Prisoner's Dilemmas. For each game, how do the changes in payoffs affect how you play? In particular, in Prisoner's Dilemma, a player will generally choose to defect. This results in a non-optimal payoff for each player. Is this still true in , , and ? If possible, use changes in the to help explain any differences in how one should play.    We can now define defection defection defect strategy strategy defect as the idea that if everyone did it, things would be worse for everyone. Yet, if only one (or a small) number did it, life would be sweeter for individual defectors. We can define cooperation cooperation cooperate strategy strategy cooperate as the act of resisting temptation for the betterment of all players.   Example from real life   Give an example of defection and cooperation from real life. Explain how your example of defection make things worse for everyone if everyone did it, but would benefit the defector. Explain how cooperation improves things for all, even if the payoff is smaller for the individual.     Check Your Understanding  Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     10  R    -1  S    5  P    15  T    True or False: the game satisfies the . True.  Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     10  R    -1  S    2  P    5  T    True or False: the game satisfies the . False.  Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     2  R    -5  S    -2  P    5  T    True or False: the game satisfies the . True.  The game has equilibrium point(s).    is the only equilibrium point.     Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     2  R    0  S    -2  P    5  T    True or False: the game satisfies the . False.  The game has equilibrium point(s).     and is the two equilibrium points.    Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     0  R    -15  S    -10  P    20  T    True or False: the game satisfies the . False.  The game has equilibrium point(s).    is the only equilibrium point.      "
},
{
  "id": "T_CWPD",
  "level": "2",
...
},
{
  ...
  "body": " The conditions for Classwide Prisoner's Dilemma   Show the hold for the Class-wide Prisoner's Dilemma in .   "
},
{
  "id": "E_PDshow",
  "level": "2",
  ...
  "body": " The conditions for Prisoner's Dilemma   Recall the matrix for Prisoner's Dilemma from .   Prisoner's Dilemma (again).      Prisoner 2      Confess  Don't Confess    Prisoner 1  Confess       Don't Confess       Determine and for this game. Be careful, think about what cooperating versus defecting should mean. Show the are satisfied.   Time in jail is bad, so the bigger the number, the worse you do; thus, it might be helpful to think of the payoffs as negatives.  "
},
{
  "id": "A_chickenshow",
  "level": "2",
  ...
  "body": " The conditions for Chicken   Recall the matrix for Chicken from .   Chicken (again).      Driver 2      Swerve  Straight    Driver 1  Swerve       Straight       Determine and for this game. Again, think about what cooperating and defecting mean in this game. Determine if the are satisfied. If not, which condition(s) fail?   "
},
{
  ...
  "body": " The conditions on another game   Consider the cooperate-defect game where the first row\/column is C and the second row\/column is D:    Determine and for this game. Determine if the are satisfied. If not, which condition(s) fail?   "
},
{
  ...
  "body": " A little more practice   Consider the cooperate-defect game where the first row\/column is C and the second row\/column is D:   Determine and for this game. Determine if are satisfied. If not, which condition(s) fail?   "
},
{
  ...
  "body": " Compare the games   The games in , , and are not true Prisoner's Dilemmas. For each game, how do the changes in payoffs affect how you play? In particular, in Prisoner's Dilemma, a player will generally choose to defect. This results in a non-optimal payoff for each player. Is this still true in , , and ? If possible, use changes in the to help explain any differences in how one should play.   "
},
{
  "id": "S_PDconditions-16",
  "level": "2",
  "url": "S_PDconditions.html#S_PDconditions-16",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Example from real life   Give an example of defection and cooperation from real life. Explain how your example of defection make things worse for everyone if everyone did it, but would benefit the defector. Explain how cooperation improves things for all, even if the payoff is smaller for the individual.   "
},
{
  ...
  "number": "4.4.1",
  "title": "",
  "body": "Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     10  R    -1  S    5  P    15  T   "
},
{
  ...
  "number": "4.4.2",
  "title": "",
  "body": "True or False: the game satisfies the . True. "
},
{
  ...
  "number": "4.4.3",
  "title": "",
  "body": "Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     10  R    -1  S    2  P    5  T   "
},
{
  ...
  "number": "4.4.4",
  "title": "",
  "body": "True or False: the game satisfies the . False. "
},
{
  ...
  "number": "4.4.5",
  "title": "",
  "body": "Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     2  R    -5  S    -2  P    5  T   "
},
{
...
},
{
  ...
  "number": "4.4.7",
  "title": "",
  "body": "The game has equilibrium point(s).    is the only equilibrium point.    "
},
{
  ...
  "number": "4.4.8",
  "title": "",
  "body": "Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     2  R    0  S    -2  P    5  T   "
},
{
...
},
{
  ...
  "number": "4.4.10",
  "title": "",
  "body": "The game has equilibrium point(s).     and is the two equilibrium points.   "
},
{
  ...
  "number": "4.4.11",
  "title": "",
  "body": "Consider the cooperate-defect game  Match the reward for mutual cooperation (R), the punishment for defecting (P), the temptation to defect (T), and the sucker's payoff (S) with their corresponding payoffs.   Make sure you identify which row (column) is cooperating and which is defecting first.     0  R    -15  S    -10  P    20  T   "
},
{
...
},
{
  ...
  "body": " Unlikely to volunteer   For which questions in was it unlikely that there would be very many volunteers? Did you take that into consideration when deciding if you were going to volunteer?   "
},
{
  "id": "A_reasonsV",
  "level": "2",
  ...
  "body": " Reasons to volunteer   What are some reasons for volunteering? What are some reasons for not volunteering?   "
},
{
...
},
{
  ...
  "number": "4.5.6",
  "title": "",
  "body": "True or False: In trying to get the best outcome for yourself in this experiment, it is useful to consider how likely it is that other people volunteer. For example, if you think there are likely to be other volunteers, you may not want to volunteer. You can get the benefit without the cost of volunteering. True. "
},
{
  "id": "S_VolunteerDil",
  "level": "1",
...
},
{
  ...
  "body": " Class-wide Prisoner's Dilemma (again).      Player 2      Cooperate  Defect    Player 1  Cooperate       Defect      "
},
{
...
},
{
  ...
  "number": "4.6.13",
  "title": "",
  "body": "Consider the class-wide or multiplayer Prisoner's Dilemma with the following payoff matrix where every player is playing the game against every other player. Suppose you are playing this game in a class of 20 people. If one player chooses Row\/Column 1 and 19 choose Row\/Column 2, how many points does a defector get?    Correct, every defector gets 5 points from the one cooperator, but 0 from the other 18 defectors.  Incorrect, this is how many points a single cooperator gets.  Incorrect. How many cooperators is the defector playing against? How many defectors?   "
},
{
...
},
{
  ...
  "body": " A Prisoner's Dilemma matrix.      Player 2      Cooperate  Defect    Player 1  Cooperate       Defect      "
},
{
  ...
  "body": " A single internet purchase   Suppose the matrix in represents the situation of purchasing a rare book on the internet where both parties are untraceable. You agree to send the money at the same time that the seller agrees to send the book. Then we can think of cooperating as each of you sending money\/ book, and defecting as not sending money\/ book. Why might a player cooperate? Why might a player defect?   "
},
{
  ...
  "body": " Repeated internet purchases   Now suppose you wish to continue to do business with the other party. For example, instead of buying a rare book, maybe you are buying music downloads. Why might a player cooperate? Why might a player defect? Do these reasons differ from your reasons in ?   "
},
{
  "id": "A_RPDstrategy",
  "level": "2",
  ...
  "body": " Strategy for repeated Prisoner's Dilemma  We are going to play the repeated version of Prisoner's Dilemma.   Suggest a strategy for playing the Prisoner's Dilemma in repeatedly. DON'T SHARE YOUR STRATEGY WITH ANYONE YET!    Play 10 rounds of Prisoner's Dilemma with someone else. Use your suggested strategy from (a). Keep track of the payoffs.   Did your strategy seem effective? What should it mean to have an effective strategy?  "
},
{
  "id": "S_RepeatPD-12",
  "level": "2",
...
},
{
  ...
  "number": "4.7.2",
  "title": "",
  "body": "In a standard game of Chicken, the best outcome for a player is if they , while their opponent .   cooperate; cooperates Although both players tie when they both cooperate, it does not result in the best payoff for a single player.  cooperate; defects This is an equilibrium, but not the one with the best payoff.  defect; defects This is the worst outcome.  defect; cooperates Correct. A player really wants their opponent to cooperate while they defect.  defect; cooperates "
},
{
...
},
{
  ...
  "number": "4.7.5",
  "title": "",
  "body": "In a repeated (or iterated) Prisoner's Dilemma, if a player always defects, then the other player should .   cooperate. A player does not want to get the sucker's payoff.  defect. Correct. The reward for defection is better than the sucker's payoff.  defect. "
},
{
  ...
  "number": "4.7.6",
  "title": "",
  "body": "In a repeated (or iterated) game of Chicken, if a player always defects, then the other player should .   cooperate. Correct. A player would rather swerve than crash.  defect. If your opponent always drives straight, you want to always swerve.  cooperate. "
},
{
...
},
{
  ...
  "number": "4.8.7",
  "title": "",
  "body": "Given the classic presentation of Chicken (players choosing to risk their lives driving towards each other), it can be tempting to say that the only rational approach to Chicken is just to refuse to play. In Crazy Rich Asians , do the characters have such a choice? Explain how the situation forces the characters to engage in the game of Chicken. You might consider what it means for a character to refuse to play. "
},
{
  "id": "S_PopPD-19",
  "level": "2",
  "url": "S_PopPD.html#S_PopPD-19",
  "type": "Question",
  "number": "4.8.8",
  "title": "",
...
},
{
  ...
  "number": "4.8.10",
  "title": "",
  "body": "As we studied Prisoner's Dilemma, we saw that it was more rational to defect (choose Foe). It turns out, over the course of the game show, more contestants chose Friend. Explain why, in this context, you think people often chose Friend. "
},
{
  "id": "S_PopPD-23",
  "level": "2",
  ...
  "number": "4.8.11",
  "title": "",
  "body": "Explain why this game in Survivor is a Volunteer's Dilemma. If you were a contestant on Survivor , what would you choose to do and why? Are there certain conditions that would make you more likely to choose Risk? If you are familiar with the show, you might want to think about whether you are more or less likely to Risk your vote if you feel you are in danger of being voted off the island. "
},
{
  "id": "S_PopPD-25",
  "level": "2",
  "url": "S_PopPD.html#S_PopPD-25",
  "type": "Question",
  "number": "4.8.12",
  "title": "",
  "body": " Explain why this version of the game is more complicated than a standard Volunteer's Dilemma. How would you decide whether or not to complete your task if you were playing this game? Would it matter which task you were given? Even if you couldn't communicate, how would knowing who your fellow contestants are help you decide whether to complete your task?  "
},
{
  "id": "S_PopPD-27",
  "level": "2",
  "url": "S_PopPD.html#S_PopPD-27",
  "type": "Question",
  "number": "4.8.13",
  "title": "",
  "body": " Suppose players are allowed to communicate in a Prisoner's Dilemma. Explain the relationship between trust and communication in a Prisoner's Dilemma. Give an example demonstrating the relationship.  "
},
{
  "id": "S_PopPD-28",
  "level": "2",
  "url": "S_PopPD.html#S_PopPD-28",
  "type": "Question",
  "number": "4.8.14",
  "title": "",
...
},
{
  "id": "S_PopPD-30",
  "level": "2",
  "url": "S_PopPD.html#S_PopPD-30",
  "type": "Question",
  "number": "4.8.16",
  "title": "",
  "body": " Give an example of a political or social situation that can be modeled by a Prisoner's Dilemma or Chicken, what does it mean to cooperate or defect in this situation?  "
},
{
  "id": "S_PopPD-31",
  "level": "2",
  "url": "S_PopPD.html#S_PopPD-31",
  "type": "Question",
  "number": "4.8.17",
  "title": "",
  "body": "Find a news article that describes a political or economic situation as being either a Prisoner's Dilemma or a game of Chicken. Do you agree that the situation is appropriately described as that game? Does the article seem to favor cooperating or defecting? Explain your answer. "
},
{
  "id": "backmatter-2",
  "level": "1",
